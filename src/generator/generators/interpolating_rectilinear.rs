...
pub struct InterpolatingRectilinearGenerator<'a, 'b> {
    params: &'a Params,
    terrain: &'b Terrain,
    start: SystemTime,
}
...
impl<'a, 'b> Generator for InterpolatingRectilinearGenerator<'a, 'b> {
    fn generate(&self) -> Vec<Vec<ResultPixel>> {
        println!(
            "{:.3}: Generating FoV data...",
...
impl<'a, 'b> InterpolatingRectilinearGenerator<'a, 'b> {
